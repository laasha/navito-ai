...
const SystemDesigner: React.FC = () => {
    ...
    return (
        <div className="glass-effect rounded-xl p-6">
            <h3 className="text-xl font-semibold mb-2">AI სისტემის დიზაინერი 🧠</h3>
            <p className="text-sm text-gray-400 mb-4">აღწერეთ პრობლემა ან მიზანი და AI შექმნის თქვენთვის პერსონალურ სამოქმედო გეგმას, რომელიც მოიცავს ჩვევებს, დავალებებს და რეფლექსიის კითხვებს.</p>
            ...
            {!system && (
                 <div className="space-y-3">
                    <textarea 
                        ...
                        placeholder="მაგ: მინდა დავამარცხო პროკრასტინაცია, ან გავხდე უფრო ენერგიული დილით..."
                    />
